...
def main(args):
    ...
    if mode == "transcript":
        ...
        # "Data/data_email/data_riseup_email.csv"
        email_data_file = "Data/data_email/slices/slice_1.csv"
        transcript_mode.run(data_file=email_data_file,
                            conf_file=config_file, exp_dir=experiment_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-mode", default="transcript",
                        help="The mode in which we want to run the simulator: transcript, synthetic traces, anon or test")
    parser.add_argument(
        "-exp_dir", help="The directory of the experiment directory")
    parser.add_argument(
        "-config_file", help="The file of the experiment configuration")
    ...
    parser.add_argument(
        "-12hour", help="Take only the 12hour slice of dataset")
