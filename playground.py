...
if __name__ == "__main__":
    ...
    test_mode.run(exp_dir='playground_experiment',
                  conf_file=None, conf_dic=config)
    ...
    entropy = anonymity_metrics.getEntropy(
        entropyLogs, config["misc"]["num_target_packets"])
    ...
    if unlinkability[0] == None:
        print(">>> E2E Unlinkability: epsilon= -, delta=%f)" %
              unlinkability[1])
    else:
